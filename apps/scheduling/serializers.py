...
class GruposSerializer(serializers.ModelSerializer):
    # --- CAMBIOS AQUÍ ---
    # 1. El campo ahora se llama 'materias_detalle' (plural)
    # 2. Apunta a 'materias' (el nombre del campo en el modelo)
    # 3. Se añade 'many=True' para la relación ManyToMany
    ...
    class Meta:
        model = Grupos
        # --- CAMBIOS EN FIELDS ---
        # Se quita 'materia' y 'materia_detalle' y se añaden los nuevos nombres en plural.
        fields = [
            'grupo_id', 
            'codigo_grupo', 
            'carrera', 
            ...
            'ciclo_semestral',
            'turno_preferente',
            'docente_asignado_directamente', 
            'docente_asignado_directamente_nombre',
            'materias', # Muestra una lista de los IDs de las materias
            'materias_detalle' # Muestra el detalle completo de cada materia
        ]
