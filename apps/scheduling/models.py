...
class Grupos(models.Model):
    ...
    carrera = models.ForeignKey(Carrera, on_delete=models.CASCADE, related_name='grupos_carrera')
    periodo = models.ForeignKey(PeriodoAcademico, on_delete=models.CASCADE, related_name='grupos_periodo')
...
class HorariosAsignados(models.Model):
    ...
    materia = models.ForeignKey(Materias, on_delete=models.CASCADE, related_name='clases_asignadas',null=True)
    ...
    def __str__(self):
        return f"{self.grupo.codigo_grupo} ({self.materia.nombre_materia}) en {self.espacio} con {self.docente}"
    ...
    class Meta:
        ...
        unique_together = [
            ...
            ('grupo', 'periodo', 'dia_semana', 'bloque_horario'), 
        ]
